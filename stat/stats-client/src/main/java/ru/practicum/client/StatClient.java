...
public class StatClient {
    ...
    public void addStats(StatsDto statsDto) {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);

        HttpEntity<StatsDto> requestEntity = new HttpEntity<>(statsDto, headers);
        restTemplate.exchange(serverUrl + "/hit", HttpMethod.POST, requestEntity, StatsDto.class);
    }
    ...
    public List<ViewStatsDto> getStats(String start, String end, List<String> uris, Boolean unique) {
        ...
        try {
            ...
            throw new StatsException("Json error: " + exception.getMessage());
        }
    }
}